                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">superadmin@invoke.com</span>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card p-3 mb-2">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="mt-5">
                                            <div class="mt-3"> <span class="text1">{{$user_total}}</span> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card p-3 mb-2">
                                    ...
                                    <div class="mt-5">
                                        <h3 class="heading">Total Jobs</h3>
                                        <div class="mt-5">
                                            <div class="mt-3"> <span class="text1">{{$jobCount}}</span> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card p-3 mb-2">
                                    ...
                                    <div class="mt-5">
                                        <h3 class="heading">Total Departments</h3>
                                        <div class="mt-5">
                                            <div class="mt-3"> <span class="text1">{{$departmentCount}}</span> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
